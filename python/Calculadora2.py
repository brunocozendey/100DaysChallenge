...
entrada.grid(column=2,row=1,sticky='EW')
btnUm = Button(frame3,text="1",command= lambda:OnButtonNumClick(1))
btnUm.grid(column=3,row=4)
btnDois = Button(frame3,text="2",command=lambda:OnButtonNumClick(2))
btnDois.grid(column=2,row=4) 
btnTres = Button(frame3,text="3",command=lambda:OnButtonNumClick(3))
btnTres.grid(column=1,row=4) 
btnQuatro = Button(frame3,text="4",command=lambda:OnButtonNumClick(4))
btnQuatro.grid(column=3,row=3)
btnCinco = Button(frame3,text="5",command=lambda:OnButtonNumClick(5))
btnCinco.grid(column=2,row=3)
btnSeis = Button(frame3,text="6",command=lambda:OnButtonNumClick(6))
btnSeis.grid(column=1,row=3)
btnSete = Button(frame3,text="7",command=lambda:OnButtonNumClick(7))
btnSete.grid(column=3,row=2)
btnOito = Button(frame3,text="8",command=lambda:OnButtonNumClick(8))
btnOito.grid(column=2,row=2)
btnNove = Button(frame3,text="9",command=lambda:OnButtonNumClick(9))
btnNove.grid(column=1,row=2)
btnZero = Button(frame3,text="0",command=lambda:OnButtonNumClick(0))
btnZero.grid(column=2,row=5)

btnSoma = Button(frame3, text=".", command=lambda:OnButtonOperClick("."))
btnSoma.grid(column=1, row=5)

btnSoma = Button(frame3, text="+", command=lambda:OnButtonOperClick("+"))
btnSoma.grid(column=2, row=6)
btnSubtracao = Button(frame3, text="-", command=lambda:OnButtonOperClick("-"))
...
btnIgual = Button(frame3, text=")", command=lambda:OnButtonNumClick(")"))
btnIgual.grid(column=1, row=7)

btnIgual = Button(frame3, text="(", command=lambda:OnButtonNumClick("("))
btnIgual.grid(column=1, row=6)

btnIgual = Button(frame3, text="=", command=lambda:OnButtonIgualClick())
btnIgual.grid(column=3, row=5)

btnClr = Button(frame2, text="CLR", command=lambda:OnButtonClrClick())
btnClr.grid(column=0, row=0)

btnBksp = Button(frame2, text="<-", command=lambda:OnButtonBkspClick())
btnBksp.grid(column=1, row=0)
